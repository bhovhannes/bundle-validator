...
var parcelRequire = $parcel$global['parcelRequire7c94']
if (parcelRequire == null) {
  ...
  $parcel$global['parcelRequire7c94'] = parcelRequire
}

$parcel$export(module.exports, 'getKebabCase', () => $14cdcf5048e22afa$export$4123a29891c86bc1)
parcelRequire.register('23Twj', function (module, exports) {
  ;(function () {
    ...
    /** Used as references for various `Number` constants. */ var INFINITY = 1 / 0,
      ...
      MAX_INTEGER = ,
      NAN = 0 / 0
    ...
    /** Detect free variable `global` from Node.js. */ var freeGlobal =
      typeof $parcel$global == 'object' &&
      $parcel$global &&
      $parcel$global.Object === Object &&
      $parcel$global
     ...
     */ var runInContext1 = function runInContext(context) {
       ...
       */ function baseMap(collection6, iteratee) {
        var index = -1,
          result = isArrayLike(collection6) ? Array(collection6.length) : []
       ...
       */ function equalArrays(array, other, bitmask, customizer, equalFunc, stack) {
        ...
        while (++index < arrLength) {
          var arrValue = array[index],
            othValue1 = other[index]
          if (customizer)
            var compared = isPartial
              ? customizer(othValue1, arrValue, index, other, array, stack)
              : customizer(arrValue, othValue1, index, array, other, stack)
          ...
          if (seen) {
            ...
            !(arrValue === othValue1 || equalFunc(arrValue, othValue1, bitmask, customizer, stack))
          ) {
            result = false
            break
          }
       ...
       */ function toArray(value) {
        ...
        var tag = getTag(value),
          func = tag == mapTag ? mapToArray : tag == setTag ? setToArray : values1
        return func(value)
      }
      /**
       ...
       */ function transform1(object4, iteratee, accumulator) {
        var isArr = isArray(object4),
          isArrLike = isArr || isBuffer(object4) || isTypedArray(object4)
      ...
      baseForOwn(LazyWrapper.prototype, function (func, methodName) {
        ...
        lodash.prototype[methodName] = function () {
          var value1 = this.__wrapped__,
            ...
            isLazy = value1 instanceof LazyWrapper,
            iteratee = args[0],
            useLazy = isLazy || isArray(value1)
...
var $23Twj = parcelRequire('23Twj')
function $14cdcf5048e22afa$export$4123a29891c86bc1(s) {
  return $23Twj.kebabCase(s)
}
